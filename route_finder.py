...
def geocoding(location, key):
    ...
    Also handles errors and formats the location name for output.
    """
    while location == "":
...
def _process_route_finder_logic(key, route_url):
    """
    Encapsulates the core application logic (user input, geocoding, routing API call, 
    and output) to reduce the main loop's complexity and satisfy C901.
    Returns False if the user types 'q' or 'quit'.
    """
    ...
    # Only proceed if both geocoding calls were successful
...
# --- Main Loop (Simplified to satisfy C901) ---
while True:
    console.print("\n" + "=" * 45)
